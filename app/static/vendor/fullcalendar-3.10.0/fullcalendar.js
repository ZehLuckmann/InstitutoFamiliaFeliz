...
var EventDef = /** @class */ (function () {
    ...
    EventDef.prototype.applyManualStandardProps = function (rawProps) {
        ...
        if (rawProps.id != null) { // accept this prop, even tho somewhat internal
            this.uid = String(rawProps.id);
        }
        else {
...
var Calendar = /** @class */ (function () {
    ...
    */
    ...
    Calendar.prototype.removeEvents = function (legacyQuery) {
        ...
        if (legacyQuery == null) { // shortcut for removing all
            ...
            for (i = 0; i < legacyInstances.length; i++) {
                eventDef = this.eventManager.getEventDefByUid(legacyInstances[i].id);
    ...
    Calendar.prototype.updateEvent = function (eventProps) {
        var eventDef = this.eventManager.getEventDefByUid(eventProps.id);
        var eventInstance;
    ...
    if (legacyQuery == null) {
        ...
        return legacyEventInstances.filter(function (legacyEventInstance) {
            ...
            return legacyEventInstance.id == legacyQuery ||
                legacyEventInstance.id === legacyQuery; // can specify internal id, but must exactly match
        });
    }
}
